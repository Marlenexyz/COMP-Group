...
class Menu:
    def __init__(self,screen_height,screen_width):
        ...
        self.enter_player_names_button = {"text": "Enter Player Names", "rect": pygame.Rect(self.screen_height/2, 450, 200, 50)}
        ...
        self.input_text = ""
        self.input_rect = pygame.Rect(self.screen_width // 2 - 100, 500, 200, 50)
